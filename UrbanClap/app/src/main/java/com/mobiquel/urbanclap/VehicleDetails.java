...
public class VehicleDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VehicleTypeSpinnerAdapter adapter = new VehicleTypeSpinnerAdapter(this,
                R.layout.vehicle_type_spinner_list_item, R.id.title, list);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (responseObject.has("errorCode") && responseObject.getInt("errorCode") == 0) {
                        ...
                        // typeOfVehicle.setText(responseObject.getJSONObject("responseObject").getString("type"));
                        ...
                        //"type":"2W","license":"Alto","number":"DL3455"
        ...
        switch (v.getId()) {
            case R.id.updateVehicle:
                if (vehicleNumber.getText().toString().equals("")) {
                    Utils.showToast(VehicleDetails.this, "Please enter vehicle number!");
                } else if (drivingLicenseNo.getText().toString().equals("")) {
                    Utils.showToast(VehicleDetails.this, "Please enter DL number");
                } else {
                    submitVehicleInfo();
                }
                break;
