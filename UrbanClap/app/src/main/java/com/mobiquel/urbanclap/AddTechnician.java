...
import com.mobiquel.urbanclap.adapter.VehicleTypeSpinnerAdapter;
import com.mobiquel.urbanclap.model.VehicleTypeModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTechnician.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    {
                        Utils.showToast(AddTechnician.this,"Please enter Technician name!");
                    }
                    else  if(mobileNo.getText().toString().equals(""))
                    {
                        Utils.showToast(AddTechnician.this,"Please enter Mobile Number!");

                    }
                    else  if(!Utils.validatePhoneNumber(mobileNo.getText().toString()))
                    {
                        Utils.showToast(AddTechnician.this,"Please enter valid Mobile Number!");
    ...
    private void getRolesTechnicianRefer() {
        ...
        StringRequest requestObject = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (responseObject.has("errorCode") && responseObject.getString("errorCode").equals("0")) {
                        ...
                        ArrayAdapter<String> roleAdapter = new ArrayAdapter<String>(AddTechnician.this,
            ...
            protected Map<String, String> getParams() {
                Preferences.getInstance().loadPreferences(AddTechnician.this);
        ...
        if (Utils.isNetworkAvailable(AddTechnician.this)) {
            queue.add(requestObject);
        } else {
            if (progressBar != null && progressBar.isShown()) {
                progressBar.setVisibility(View.GONE);
            }
            Utils.showToast(AddTechnician.this, AppConstants.MESSAGES.ENABLE_INTERNET_SETTING_MESSAGE);
        }
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (responseObject.has("errorCode") && responseObject.getString("errorCode").equals("0"))
                    {
                        ...
                        Utils.showToast(AddTechnician.this, responseObject.getString("errorMessage"));
                       finish();
                    }
                    else
                    {
