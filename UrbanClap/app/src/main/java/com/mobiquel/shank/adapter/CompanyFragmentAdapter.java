...
import com.mobiquel.shank.fragments.HRApprovedFragment;
import com.mobiquel.shank.fragments.HRMemberFragment;
import com.mobiquel.shank.fragments.HRPendingFragment;
import com.mobiquel.shank.fragments.HRVerifiedFragment;
...
public class CompanyFragmentAdapter extends FragmentPagerAdapter {
    ...
    public CompanyFragmentAdapter(FragmentManager fm, String source) {
        super(fm);
        this.source=source;
    }
