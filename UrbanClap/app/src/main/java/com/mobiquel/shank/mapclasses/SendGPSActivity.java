package com.mobiquel.shank.mapclasses;
...
//import com.mobiquel.klevermindtransport.dao.DAO;
import com.mobiquel.shank.dao.DAO;
	...
	private void sendGPSLocation(final String lat,final String lon,final String id)
	{
			...
			}) 
		{
			...
			protected Map<String, String> getParams()  
			{
				...
				Log.e("PARAMS_GPS", params.toString());
				return params;
			}
		};
