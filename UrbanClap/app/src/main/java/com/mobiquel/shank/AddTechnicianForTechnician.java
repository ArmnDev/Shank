...
public class AddTechnicianForTechnician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTechnician.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    {
                        Utils.showToast(AddTechnicianForTechnician.this,"Please enter Technician name!");
                    }
                    else  if(mobileNo.getText().toString().equals(""))
                    {
                        Utils.showToast(AddTechnicianForTechnician.this,"Please enter Mobile Number!");

                    }
                    else  if(!Utils.validatePhoneNumber(mobileNo.getText().toString()))
                    {
                        Utils.showToast(AddTechnicianForTechnician.this,"Please enter valid Mobile Number!");
    ...
    private void getRolesTechnicianRefer() {
        ...
        StringRequest requestObject = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (responseObject.has("errorCode") && responseObject.getString("errorCode").equals("0")) {
                        ...
                        ArrayAdapter<String> roleAdapter = new ArrayAdapter<String>(AddTechnicianForTechnician.this,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Utils.showToast(AddTechnicianForTechnician.this, AppConstants.MESSAGES.ERROR_FETCHING_DATA_MESSAGE);
            }
        }) {
            @Override
            protected Map<String, String> getParams() {
                Preferences.getInstance().loadPreferences(AddTechnicianForTechnician.this);
        ...
        if (Utils.isNetworkAvailable(AddTechnicianForTechnician.this)) {
            queue.add(requestObject);
        } else {
            if (progressBar != null && progressBar.isShown()) {
                progressBar.setVisibility(View.GONE);
            }
            Utils.showToast(AddTechnicianForTechnician.this, AppConstants.MESSAGES.ENABLE_INTERNET_SETTING_MESSAGE);
        }
    }
        ...
        StringRequest requestObject = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (responseObject.has("errorCode") && responseObject.getString("errorCode").equals("0"))
                    {
                        Utils.showToast(AddTechnicianForTechnician.this, responseObject.getString("errorMessage"));
                        finish();
                    }
                    else
                    {
