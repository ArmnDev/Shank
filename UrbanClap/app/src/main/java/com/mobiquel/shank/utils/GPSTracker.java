...
public class GPSTracker extends Service implements LocationListener {
	...
	/**
	 * Function to show settings alert dialog On pressing SettingsTechnician button will
	 * lauch SettingsTechnician Options
	 * */
	public void showSettingsAlert(final Context c) 
	{
		...
		alertDialog.setPositiveButton("SettingsTechnician",
